...
export const MOCK_SCHEDULE: Schedule = {
  date: 'Wednesday',
  items: [
    { time: '5:10AM', class: 'FULL BODY', coach: '(Sub: Kerri Daniels)' },
    { time: '6:05AM', class: 'FULL BODY', coach: '(Sub: Kerri Daniels)' },
    { time: '9:00AM', class: 'FEMME BOOTCAMP', coach: '(Glenda Ortiz)' },
    { time: '12:00PM', class: 'ZUMBA', coach: '(Lama Alassil)' },
    { time: '5:15PM', class: 'ABS & BOOTY', coach: '(Alexis Mobley)' },
    { time: '6:15PM', class: 'STEP UP', coach: '(Audrey Carryl)'},
  ],
};
